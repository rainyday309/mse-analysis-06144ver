...
scale1_2 <- completer[,grepl("scale[1-2]$",x=names(completer))]
scale1_2 <- scale1_2[,grepl("pre|post",x=names(scale1_2))]

scale3_5 <- completer[,grepl("scale[3-5]",x=names(completer))]
scale3_5 <- scale3_5[,grepl("pre|post",x=names(scale3_5))]

scale6_10 <- completer[,grepl("scale[6-9]|scale10",x=names(completer))]
scale6_10 <- scale6_10[,grepl("pre|post",x=names(scale6_10))]

output1_2<- data.frame(matrix(nrow = 103,ncol=0))
output3_5<- data.frame(matrix(nrow = 103,ncol=0))
output6_10<- data.frame(matrix(nrow = 103,ncol=0))
